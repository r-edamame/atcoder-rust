...
fn main() {
    ...
    for x in 0..n {
        ...
        for y in 0..n {
            if mat[y][x] == '#' {
                counts[y+1] = counts[y] + 1;
            } else {
                counts[y+1] = counts[y];
            }
        }
        for y in 0..n-6 {
            if counts[y+6] - counts[y] >= 4 {
                yesno(true);
                return;
            }
        }
    ...
    for y in 1..n-6+1 {
        ...
        for i in 0..counts.len()-6 {
            if counts[i+6] - counts[i] >= 4 {
                yesno(true);
                return;
            }
        }
